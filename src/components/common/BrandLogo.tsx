...
export const BrandLogo: React.FC<BrandLogoProps> = ({ className = "", size = "md", showSubtitle = false }) => {
  ...
  return (
    <div className={`flex items-center gap-3 select-none ${className}`}>
      {/* Official Islam Roots Logo Image Asset */}
      <div
        className="relative flex items-center justify-center rounded-xl bg-black overflow-hidden shadow-soft shrink-0 border border-stone-800/60"
